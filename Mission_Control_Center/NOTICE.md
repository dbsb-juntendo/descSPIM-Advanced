...
MCC is research software and is not intended or approved for clinical diagnosis, medical treatment, or safety-critical applications.

MCC can control cameras, lasers, motorized stages, galvanometric mirrors, filter changers, and other physical laboratory equipment. Users are solely responsible for verifying the safety, compatibility, configuration, and operation of all connected equipment.

Users must implement appropriate laser-safety measures, motion limits, emergency-stop procedures, electrical safeguards, data backups, and other protections required by applicable laws, institutional rules, and equipment manufacturers.

The software is provided without any representation that it is suitable for a particular instrument, experiment, regulatory requirement, or operating environment.
